...
(signaling protocol and media)system with DTLS 1.2 with AES 256 and SRTP with AES 128"
              ...
              description_5="• I was involved in the development activity focussed towards making the main CS design scalable to support more users(approx 15k users by a single CS was involved in the traffic benchmarking for the product under different configurations"
              description_6="• This benchmarking involved several fine tuning of the configurations in the architecture level and handling of memory objects at the application level."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description_4="• One sub feature in the wide cloud model is the LICENSING MECHANISM and I was part of a development team that worked on an implementation which maintains, validates and does a periodic license checks of the products deployed by the client through communication with the cloud servers deployed.In short I was working for the client side implementation."
			        description_5="• Hence eventhough I never worked in a typical cloud application directly, but I got a good grasp of the environment and setup of a modern cloud architecture through my development activities to make the deployed client device communicate with the cloud server. "
			        description_6="• The delopment activities were done in C++ with extensive usage of the XMPP protocol for instant secure communication to work over the Linux platform."
