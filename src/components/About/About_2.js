        ...
        <Row style={{ fontSize: "1.0em" ,color:'white',textAlign:'left'}}>
            ...
            <h1 style={{ fontSize: "2.6em" }}>
              <span className="purple"> I know things</span>
                ...
                I am a great developer. I am efficient with C,C++ and I know Unix/Linux ecosystem pretty well. Pointers don't frighten me and neither do tricky data structures or an obscure compiler configuration. My code is clean, tested and meant to be readable by humans. In addition , I know my way around frontend and virtualization environments and I have played with Python, Bash and I assume myself that I am interested in Front-end development as well which you can see from the funky design of this site..
          ...
          <p>
            <h1 style={{ fontSize: "2.6em" }}>
              <span className="purple">I do things</span>
                ...
                I had various roles. Depending on the team and the project's needs, I can play different roles. Developer, lead developer, even "occasional sysadmin" if needed. 
                ...
                I communicate well. Don't see me as the developer writing code alone in his room. I do not hide myself behind a dark screen full of green symbols, quite the opposite. I can be found giving presentations to my colleagues, more formal talks in project meetings, … I also am an adept of pair programming and code reviews. In all these occasions, but also for written exchanges, I always try to be precise, diplomatic and honest.
        ...
        <Row>
          ...
          <span className="purple"> What am I doing now?</span>
            ...
            <p style={{ fontSize: "1.0em",color:'white',textAlign:'justify'}}>
              ...
              But the thrill and excitement of learning something new in a complete strange land very far away from my comfort zone keeps me ticking and helps to stay on the boots.I have had a mix of results in my grades ranging from A to C, but even the coursework with least grade has left me with an  immense learning which is ultimately the goal of pursuing this degree.
              I did few courses which introduced me formally to the world of Artificial Intelligence and Machine Learning.I did courses related to Software security,Parallel programming and Distributed processing.Few emerging and unavoidable technologies like blockhain were also in my rooster.
              On the whole the focus was to advance myself in the latest approaches of application developement, get introduced to emerging technologies and most importantly experience the multi ethnic, multi national diversity that the education system here provides.
            </p>
          ...
          <Col md={8} className="home-about-description">
            ...
            <h1 style={{ fontSize: "2.6em",textAlign:'left'}}>
              <span className="purple"> What I am looking for </span>
                ...
                Challenge motivates me. Even if I have mainly worked on traditional backend application developement for some of the legacy systems in telecom domain, I crave opportunities to discover new technologies and concepts.
